...
The General Education instructional dataset for the `r ssocData$Semester[1]` semester of `r ssocData$Year[1]` included a total of `r comma(summaryTable[11,6],format="d")` student records. This represented `r comma(summaryTable[11,2],format="d")` courses which were delivered in `r comma(summaryTable[11,3],format="d")` total sections. These classes were taught by `r comma(summaryTable[11,4],format="d")` different instructors. Some students were enrolled in more than one General Education course for a particular competency. Therefore, there were fewer unique students than records. In addition, some courses count for more than one of the General Education core competencies (double- or triple-dippers). Because of this, there are more total values (when adding up all the competencies) than the original dataset actually contained. Here is a brief breakdown of the records for this semester.
